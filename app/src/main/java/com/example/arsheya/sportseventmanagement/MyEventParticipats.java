...
public class MyEventParticipats extends AppCompatActivity implements AdapterView.OnItemClickListener {
    String category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_event_participats);
        Intent i = getIntent();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent i = new Intent(MyEventParticipats.this,MyEventDetail.class);
    ...
    public class MyAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(MyEventParticipats.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                ///chng name
                URL url = cm.getUrl("MyEventparticipants.php");
...
//3event_id,event_name,category,setplayers,s_date,e_date,settime,setaddress,setfees,l_id,setimage;
        ...
        protected void onPostExecute(String pname) {
            ...
            CustomMyevent custom_gallery = new CustomMyevent(getApplicationContext(), Arrcm);
